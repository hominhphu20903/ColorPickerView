...
class ColorPicker(context: Context, attributeSet: AttributeSet?) :
     ...
     * If [ColorAlphaSlider] is connected to this view via [alphaSliderView] then alpha value is
    ...
    override fun onDraw(canvas: Canvas) {
        canvas.run {
            ...
            drawRoundRect(rect, pickerBorderRadius, pickerBorderRadius, linePaint.apply {
                shader = colorShader
            })
            ...
            drawRoundRect(
                rect.apply {
                    left += pickerOutlineSize / 2.5f
                    top += pickerOutlineSize / 2.5f
                    right -= pickerOutlineSize /  2.5f
                    bottom -= pickerOutlineSize /  2.5f
                }, pickerBorderRadius - dp(0.5), pickerBorderRadius - dp(0.5), pickerOutlinePaint.apply {
                    strokeWidth = pickerOutlineSize
            ...
            drawCircle(
                circleX,
                circleY,
                circleIndicatorRadius - thumbOutlineSize,
                circlePaint.apply {
            ...
            drawCircle(
                circleX,
                circleY,
                circleIndicatorRadius - thumbStrokeSize - thumbOutlineSize,
                circlePaint.apply {
                    color = ColorUtils.blendARGB(colorWithFullAlpha, Color.BLACK, 0.1f)
                })

            drawCircle(
                circleX,
                circleY,
                circleIndicatorRadius - thumbStrokeSize - thumbOutlineSize - dp(1),
                circlePaint.apply {
